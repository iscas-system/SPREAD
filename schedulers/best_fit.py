...
class BestFitScheduler(Scheduler):
    ...
    def do_assign(self, preemptive: bool, now: int, done_jobs_between_preemption: Set[Job]) -> Tuple[
        ...
        for job_ID in job_IDs:
            ...
            task_comp, _ = self.data_source.job_maximized_performance_comp(job_ID=job_ID, GPU_type=self.GPU_type, worker_count=worker_count, cross_node=False)
            _, task_mem = self.data_source.get_job_task_memory(job_ID, worker_count=worker_count)
